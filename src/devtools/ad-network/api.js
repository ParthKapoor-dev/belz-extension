...
//
// Results are memoised through cache.js, so a repeat visit resolves names
// with no network at all.

import { chainV1Path, chainV2Path, designerPath } from '../../config/endpoints.js';
import { getApiOrigin, getDesignerOrigin } from './origin.js';
import { read as cacheRead, write as cacheWrite } from './cache.js';
